...
export default function DashboardPage() {
  ...
  const groupedObjectives = useMemo(
      () => (showTeamWatchlist ? groupObjectivesByOwner(objectives, userDirectory) : []),
      [objectives, showTeamWatchlist, userDirectory]
  );
        ...
        <section className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl space-y-3">
            ...
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              Track objectives, key results, and insights in one place.
            </p>
          </div>
                                ...
                                >
                                  <div className="min-w-0 space-y-2">
                                    ...
                                    <p className="text-sm text-slate-500">
                                      Team members: {teamMemberSummary}
                                    </p>
                                  </div>
          ...
          <div className="card-surface p-6">
            ...
            <div className="mt-5 space-y-4">
              <div className="rounded-[22px] border border-slate-200 bg-[#f8fbff] p-4">
                ...
                <div className="mt-1 text-sm text-slate-500">In scope right now</div>
              </div>
              <div className="rounded-[22px] border border-slate-200 bg-[#f8fbff] p-4">
                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">
                  Key results
                ...
                <div className="mt-1 text-sm text-slate-500">Tracked across objectives</div>
              </div>
              <div className="rounded-[22px] border border-slate-200 bg-[#f8fbff] p-4">
                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">
                  Insights
                ...
                <div className="mt-1 text-sm text-slate-500">Active indicators</div>
              </div>
            </div>
          </div>
        </section>
